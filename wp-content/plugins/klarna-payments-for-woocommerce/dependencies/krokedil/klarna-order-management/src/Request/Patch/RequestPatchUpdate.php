...
namespace KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaOrderManagement\Request\Patch;

use KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaOrderManagement\OrderLines;
use KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaOrderManagement\Request\RequestPatch;
if (!\defined('ABSPATH')) {
    exit;
}
/**
