...
class SignInWithKlarna
{
    ...
    public function enqueue_scripts()
    {
        ...
        $siwk_params = array('locale' => $this->settings->get('locale'), 'scope' => $this->settings->get('scope'), 'theme' => $this->settings->get('button_theme'), 'shape' => $this->settings->get('button_shape'), 'alignment' => $this->settings->get('logo_alignment'), 'redirect_uri' => Redirect::get_callback_url(), 'sign_in_from_popup_url' => \WC_AJAX::get_endpoint('siwk_sign_in_from_popup'), 'sign_in_from_popup_nonce' => wp_create_nonce('siwk_sign_in_from_popup'));
    ...
    public function add_websdk_attributes()
    {
        ...
        $attributes = array('data-locale' => $locale, 'data-scope' => $scope, 'data-market' => $market, 'data-environment' => $environment, 'data-client-id' => $client_id, 'data-redirect-uri' => $redirect_to, 'data-logo-alignment' => $alignment, 'data-theme' => $theme, 'data-shape' => $shape);
        return $attributes;
    }
    /**
