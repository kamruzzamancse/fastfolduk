...
namespace KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaOrderManagement\Request\Get;

use KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaOrderManagement\Request\RequestGet;
if (!\defined('ABSPATH')) {
    exit;
}
/**
