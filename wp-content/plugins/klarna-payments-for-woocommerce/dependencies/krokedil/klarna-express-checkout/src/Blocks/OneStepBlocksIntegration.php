...
namespace KrokedilKlarnaPaymentsDeps\Krokedil\KlarnaExpressCheckout\Blocks;
...
class OneStepBlocksIntegration implements IntegrationInterface
{
    ...
    public function initialize()
    {
        ...
        // Register the script.
        wp_register_script('kec-one-step-block', $script_path, array('wp-element', 'wp-i18n', 'wp-blocks', 'wc-blocks-registry', 'jquery'), KlarnaExpressCheckout::VERSION, \true);
    }
}
