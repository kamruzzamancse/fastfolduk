<?php
/**
 * Template part for Access Issues Step in Window Builder
 * Step 12: Are there any access issues for delivering the windows?
 *
 * @package Astra Child
 */
...
<div class="wizard-step" data-step="12">
    <div class="step-container access-container">
        <div class="step-title access-title">
            <h2>Are there any access issues for delivering the windows?</h2>
            <p class="access-description">e.g. will the window fit through your house to get to the opening?</p>
        </div>
        ...
        <div class="access-wrapper">
            <div class="access-options">
                ...
                <div class="access-card" data-price="0">
                    <input type="radio" name="window_access_issues" id="window_access_yes" value="yes_access" class="price-option" data-price="0">
                    <label for="window_access_yes">
                    ...
                    <div class="access-textarea-wrapper" style="display: none;">
                        <textarea 
                            name="window_access_description" 
                            id="window_access_description" 
                ...
                <!-- No Access Issues -->
                <div class="access-card" data-price="0">
                    <input type="radio" name="window_access_issues" id="window_access_no" value="no_access" class="price-option" data-price="0" checked>
                    <label for="window_access_no">
                        <div class="access-image">
                            <img src="<?php echo esc_url($images_dir . 'Cross_500x.webp'); ?>" 
                                srcset="<?php echo esc_url($images_dir . 'Cross_500x.webp'); ?> 1x, <?php echo esc_url($images_dir . 'Cross_500x.webp'); ?> 1x"
...
jQuery(document).ready(function($) {
    ...
    const $yesRadio = $('#window_access_yes');
    const $noRadio  = $('#window_access_no');
    ...
    function showTextarea() {
        ...
        setTimeout(function(){
            $('#window_access_description').focus();
        },300);
    }
    ...
    $('.access-card').on('click',function(e){
        ...
        if(radio.attr('id') === 'window_access_yes'){
            showTextarea();
        } else {
            hideTextarea();
        }
    ...
    =============================== */
    $('#window_access_description').on('input', function() {
        if (typeof window.validateCurrentStep === 'function') {
            window.validateCurrentStep();
        }
    });
