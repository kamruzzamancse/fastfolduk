<?php
/**
 * Template part for Trickle Vents Selection Step in Window Builder
...
<div class="wizard-step" data-step="8">
    <div class="step-container trickle-vents-container">
        ...
        <div class="step-title trickle-vents-title">
            <h2>Do you need trickle vents on your window?</h2>
                    ...
                    <label for="trickle_no">
                        <div class="trickle-vent-image">
                            <img src="<?php echo esc_url($images_dir . 'Cross_500x.webp'); ?>" 
                                 alt="Window without Trickle Vent" 
                                 width="800"
                                 height="600"
                                 loading="eager"
                                 decoding="async">
...
jQuery(document).ready(function($) {
    ...
    if (window.isDev && window.isDev()) {
        console.log('Step 8 (Trickle Vents) initialized for Window Builder');
    }
});
</script>